...
The system automatically scrapes international media sources (Brazil, China, Russia), translates articles, summarizes content, classifies relevance, stores structured data, builds FAISS indexes, and performs advanced LangChain RAG retrieval through a modern Streamlit interface.
